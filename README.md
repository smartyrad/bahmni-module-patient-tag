...
This will create a file called `bahmni-patient-tagging.zip` file in the `dist` directory,
...
This will build and deploy the app to the `/home/smarita/openmrs/platform/owa`
...
{
  "LOCAL_OWA_FOLDER": "/home/smarita/openmrs/platform/owa",
  "APP_ENTRY_POINT": bahmni-patient-tagging
}
```
